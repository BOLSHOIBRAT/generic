...
public class App {
    public static void main(String[] args) {
        // обобщенный тип должен быть классом, в котором будет реализован интерфейс IComparable<T>
...
/*
        System.out.println(tea.get(0).compareTo(tea.get(1)));
        System.out.println(tea.get(1).compareTo(tea.get(2)));
        System.out.println(tea.get(1).compareTo(tea.get(1)));
*/
